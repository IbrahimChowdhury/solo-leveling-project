                  ...
                  {syncing ? (
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className="w-full group py-4.5 bg-brand-blue text-black font-black text-xs uppercase tracking-widest rounded transition-all glow-blue hover:bg-[#00d0dd] flex items-center justify-center gap-2 cursor-pointer border-none"
                      >
